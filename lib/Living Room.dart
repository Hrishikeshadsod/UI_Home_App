            ...
            children: <Widget>[
                                ...
                                child: Container(
                                  ...
                                  child: SliderTheme(
                                    data: SliderTheme.of(context).copyWith(
                                      inactiveTrackColor: Color(0xFFF4F7FC),
              ...
              Expanded(
                ...
                child: Row(
                  children: <Widget>[
                    Expanded(
                      child: LivingRoomCard(colour: Color(0XFFE9E7F7), icon: "assets/images/light.png", label: 'Light', label2: 'On',),
                    ),
                    Expanded(
                      child: LivingRoomCard(colour: Color(0XFFFAEBE8), icon: 'assets/images/cooler.png', label: 'Cooler', label2: 'Off',),
                    ),
                    Expanded(
                      child: LivingRoomCard(colour: Color(0XFFE7F7F1), icon: "assets/images/tv.jpg", label: 'Smart TV', label2: 'Off',
                      ),
                    ),
                  ],
                ),
